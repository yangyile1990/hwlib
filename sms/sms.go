...
// func (t *twilioClient) packageData(phone string, msg string) map[string]string {
// 	return map[string]string{
// 		"To":                  phone,
// 		"MessagingServiceSid": t.cfg.MessageId,
// 		"Body":                msg,
// 	}
// 	//	curl 'https://api.twilio.com/2010-04-01/Accounts/ACdd2ab18445c4784ca24fbda9b7bc15a5/Messages.json' -X POST \
// 	//
// 	// --data-urlencode 'To=+8617612199113' \
// 	// --data-urlencode 'MessagingServiceSid=MG9aae78ab6ca7cf311bfa3867f3f62400' \
// 	// -u ACdd2ab18445c4784ca24fbda9b7bc15a5:[AuthToken]
// }
...
func Post(request_url string, data map[string]string, user string, pwd string) ([]byte, error) {
	...
	//	'https://api.twilio.com/2010-04-01/Accounts/ACdd2ab18445c4784ca24fbda9b7bc15a5/Messages.json' -X POST \
	//
	// --data-urlencode 'To=+8617612199113' \
	// --data-urlencode 'MessagingServiceSid=MG9aae78ab6ca7cf311bfa3867f3f62400' \
	// -u ACdd2ab18445c4784ca24fbda9b7bc15a5:[AuthToken]
